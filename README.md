...
La arquitectura Aws consistirá de los siguientes elementos:
	- Bucket privado: donde se guardará el ultimo estado de la web del ministerio.
	- CloudWatch -Eventbride: scheduler que se ejecutará cada 5 minutos.
	- Lambda: función desarrollada en Java 1.8 encargada de comprobar si hay novedades en la web del ministerio, e invocar el servicio AWS-SNS.
